...
# Configuration
SENDER_EMAIL = "g.yegnesh135@gmail.com"
SENDER_PASSWORD = "oezr ndkw hefz sszi"
...
def generate_email_content(query: str) -> str:
    ...
    try:
        ...
        # Validate required fields and standardize the structure
...
if __name__ == "__main__":
    ...
    # test_result = generate_email_content("Send a thank you email to yegneshwarginjupalli@gmail.com for the great meeting yesterday")
